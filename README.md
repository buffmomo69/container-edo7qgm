...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-edo7qgm.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-edo7qgm.containers.anotherwebservice.com/
...
```
git clone git@github.com:buffmomo69/container-edo7qgm.git
cd container-edo7qgm
```
...
```
docker attach container-edo7qgm
```
